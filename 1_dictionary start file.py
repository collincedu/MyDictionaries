...
phonebook.clear() #this gives you an empty dictionary
print(phonebook) 
...
print() #supposed to be random, only gives last item in 
...
list_of_keys = list(phonebook) #creates list of keys from dictionary
random_key = random.choice(list_of_keys)
phone = phonebook[random_key]

# Or Nest into one line
